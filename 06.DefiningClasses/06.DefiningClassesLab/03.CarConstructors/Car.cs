...
namespace CarManufacturer
{
    class Car
    {
        ...
        public Car(string carMake, string carModel, int carYear) : this()
        {
            Make = carMake;
            Model = carModel;
            Year = carYear;
        ...
        public Car(string carMake, string carModel, int carYear, double carFuelQuantity, double carFuelConsumption) : this(carMake, carModel, carYear)
        {
